# Power test for rqt ridge reg method, dichotomous outcome, LD presented#
library(rqt)
library(SKAT)

# how to run: > source("~/Dropbox/rqt/AppNote/MajorRevision/tests/power.tests/power.ld.dich/power.ld.dich_ridge.R")


set.seed(100500)

proj.dir <- "/Users/ilya/Projects/rqt.dev/tests/power.tests/power.ld.dich_ridge/" # project directory, change it if you need.
n.snp <- 50

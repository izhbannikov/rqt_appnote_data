...
proj.dir <- "/Users/ilya/Projects/rqt.dev/tests/power.tests/power.ld.dich_pca/" # project directory, change it if you need.
n.snp <- 50
...
for(s in c(0.1,0.25)) {
  res.pow <- list(rQT1=0, rQT2=0, rQT3=0, 
    ...
    for (i in 1:n){
        ...
        res <- geneTest(obj, method="pca", out.type = "D", cumvar.threshold = 95, weight=F)

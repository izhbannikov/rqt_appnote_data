...
library(rqt)
library(SKAT)
# how to run: source("/Users/ilya/Dropbox/rqt/AppNote/MinorRevision/tests/type1err.tests/cont/cont_t1e_lasso.R")

proj.dir <- "/Users/ilya/Projects/rqt.dev/tests/type1error.tests/cont_lasso/" # project directory, change it if you need.
n.snp <- 50
...
for(alpha in alpha.level) { 
    ...
    for (i in 1:n){
        ...
        res <- geneTest(obj, method="lasso", out.type = "C", cumvar.threshold = 70, weight=F)

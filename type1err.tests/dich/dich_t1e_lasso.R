...
# how to run: source("/Users/ilya/Dropbox/rqt/AppNote/MinorRevision/tests/type1err.tests/dich/dich_t1e_lasso.R")


proj.dir <- "/Users/ilya/Projects/rqt.dev/tests/type1error.tests/dich_lasso/" # project directory, change it if you need.
n.snp <- 50

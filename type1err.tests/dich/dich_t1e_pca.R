...
# how to run: source("/Users/ilya/Dropbox/rqt/AppNote/MinorRevision/tests/type1err.tests/dich/dich_t1e_pca.R")


proj.dir <- "/Users/ilya/Projects/rqt.dev/tests/type1error.tests/dich/" # project directory, change it if you need.
n.snp <- 50
...
for(alpha in alpha.level) { 
    ...
    for (i in 1:n){
        ...
        res <- geneTest(obj, method="pca", out.type = "D", cumvar.threshold = 70, weight=F)
